...
<body>
	<input type="hidden" id="statusHtml" value="<%= request.getAttribute("statusDispacher") %>">
						...
						<form method="post" action="registration" class="register-form"
							...
							<div class="form-group">
								<label for="name"><i
									...
									type="text" name="name" id="name" placeholder="Seu nome" required="required" />
							</div> 
							<div class="form-group">
							...
							<div class="form-group">
								<label for="pass"><i class="zmdi zmdi-lock"></i></label> <input
									type="password" name="pass" id="pass" placeholder="Senha" required="required" />
							</div>
							<div class="form-group">
	...
	<script type="text/javascript">
		var status = document.getElementById("statusHtml").value;
