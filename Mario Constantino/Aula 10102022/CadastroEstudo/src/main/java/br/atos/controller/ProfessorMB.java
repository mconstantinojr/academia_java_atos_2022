...
import br.atos.dao.ProfessorDao;
...
public class ProfessorMB {
	...
	public void init() {
	    ...
	    this.professores = professorDao.listarProfessor();
	}
	...
	public String salvarProfessor() {
		if (this.professorAlterar != null) {
			this.professor.setId(this.professorAlterar.getId());
			professorDao.alterarProfessorNoBanco(this.professor);
		} else {
			professorDao.salvarProfessorNoBanco(this.professor);
		}
	...
	public String removerProfessor(Professor professor) {
		professorDao.deleteProfessorNoBanco(professor);
		limparProfessor();
