...
public class MenuInicial {
	public void apresentarMenuInicial() {
		...
		String opcaoUmMenuTexto = "[1] Cadastro de Funcionario";
		String opcaoDoisMenuTexto = "[2] Listar Funcionario";
		String opcaoTresMenuTexto = "[3] Alterar Funcionario";
		String opcaoQuatroMenuTexto = "[4] Excluir Funcionario";
