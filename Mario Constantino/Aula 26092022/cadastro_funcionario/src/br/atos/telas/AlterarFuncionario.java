...
public class AlterarFuncionario {
	...
	public void alterarFuncionario(JFrame menuInicial, RepositorioFuncionario repositorioFuncionario, Funcionario funcionarioAtual) {
		...
		JFrame frameAlterarFuncionario = new JFrame();
		frameAlterarFuncionario.setSize(500, 600);
		...
		idParaAlterarJTextField.setText(funcionarioAtual.getId());
		...
		nomeParaAlterarJTextField.setText(funcionarioAtual.getNome());
		...
		cpfParaAlterarJTextField.setText(funcionarioAtual.getCpf());
		...
		cargoParaAlterarJTextField.setText(funcionarioAtual.getCargo());
		...
		frameAlterarFuncionario.add(panelListarFuncionario);
		frameAlterarFuncionario.setVisible(true);
		
		TelaAlterarControle telaAlterarControle = new TelaAlterarControle(frameAlterarFuncionario, menuInicial, idParaAlterarJTextField, nomeParaAlterarJTextField, cpfParaAlterarJTextField, cargoParaAlterarJTextField, repositorioFuncionario, funcionarioAtual);
		botaoAlterar.addActionListener(telaAlterarControle);
		botaoVoltar.addActionListener(telaAlterarControle);
	}
}
