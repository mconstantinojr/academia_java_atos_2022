...
public class MenuGerenteCoordenadorControle implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (opcaoMenuJTextField.getText().equals("1") || opcaoMenuJTextField.getText().equals("2") || opcaoMenuJTextField.getText().equals("3") || opcaoMenuJTextField.getText().equals("4") || opcaoMenuJTextField.getText().equals("5")) {
			...
			case "3":
				buscarFuncionarioEditar.buscarFuncionarioEditar(repositorioFuncionario, frameGerenteCoordenador);
				System.out.println("Altere um Funcionário!");
			break;

			case "4":
				excluirFuncionario.apresentarLista(repositorioFuncionario.listarFuncionario(), frameGerenteCoordenador, repositorioFuncionario);
