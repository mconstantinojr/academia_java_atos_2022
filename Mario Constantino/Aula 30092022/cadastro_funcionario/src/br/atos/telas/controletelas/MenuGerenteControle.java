...
public class MenuGerenteControle implements ActionListener {
	...
	public MenuGerenteControle() {
		
	}
	
	public MenuGerenteControle(JTextField opcaoMenuJTextFieldCr, JFrame frameMenuGerente, JFrame frameMenuGerenteCoordenador) {
